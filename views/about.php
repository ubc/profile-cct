<div id="wpbody-content">
    <div class="wrap about-wrap">
        ...
        <ol>
            <li>
				<p>Think about how you want to filter and group your profiles and then <a href="<?php echo admin_url('edit.php?post_type=profile_cct&page='.PROFILE_CCT_BASENAME.'&view=taxonomy'); ?>">create some taxonomies</a>.</p>
			</li>
            <li>
            ...
            <li>
				<p>Invite the users to edit their profiles by clicking on the edit Public Profile listed under their own Profile.</p>
			</li>
        </ol>
    </div>
    <div class="clear"></div>
