...
function profile_cct_position_field( $data, $options ){
	...
	$field->input_field( array( 'field_type'=>$type, 'multiple'=>$multiple,'field_id'=>'position','label'=>'title', 'size'=>35, 'value'=>$data['position'], 'type'=>'text') ); 
	$field->input_field( array( 'field_type'=>$type, 'multiple'=>$multiple,'field_id'=>'organization','label'=>'organization', 'size'=>35, 'value'=>$data['organization'], 'type'=>'text', 'show'=>in_array("organization",$show)) );
}
