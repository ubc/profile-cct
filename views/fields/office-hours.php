	...
	function display() {
		...
		if ( isset( $this->data['days'] ) ):
			foreach( $this->data['days'] as $day ):
				$this->display_text( array( 'class' => 'days', 'default_text' => 'Monday', 'separator'=> $separator, 'value'=> $day ) );
				$separator = ',';
			endforeach;
		
		else:
			$this->display_text( array( 'class' => 'days', 'default_text' => 'Monday', 'type' => 'text' ) );
		endif;
		$this->display_text( array( 'field_id' => 'start-hour', 'class' => 'start-hour','default_text' => '11'  ) );
		$this->display_text( array( 'field_id' => 'start-minute', 'class' => 'start-minute','default_text' => '15', 'separator' => ':' ) );
		$this->display_text( array( 'field_id' => 'start-period', 'class' => 'start-period','default_text' => 'AM' ) );
		$this->display_text( array( 'field_id' => 'end-hour', 'class' => 'end-hour','default_text' => '12', 'separator' => '-'  ) );
		$this->display_text( array( 'field_id' => 'end-minute', 'class' => 'end-minute','default_text' => '05', 'separator' => ':' ) );
		$this->display_text( array( 'field_id' => 'end-period', 'class' => 'end-period','default_text' => 'PM' ) );
