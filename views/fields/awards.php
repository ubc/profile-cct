...
function profile_cct_awards_field( $data, $options, $count = 0 ){
	...
	$field->input_field( array( 'field_type'=>$type,'multiple'=>$multiple,'field_id'=>'award-website', 'label'=>'Website','size'=>35, 'value'=>$data['award-website'],'type'=>'text', 'show' => in_array("award-website",$show),'count'=>$count));
