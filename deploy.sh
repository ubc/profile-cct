...
SVNURL="http://plugins.svn.wordpress.org/profile-custom-content-type" # Remote SVN repo on wordpress.org, with no trailing slash
SVNUSER="ejackisch" # your svn username
